<?php // Radio Button Values

	if (get_sub_field('tabs_select') == 'horizontal') :?>
		<?php echo '<h2>hortizontal tabs</h2>';?>
...
<?php if( get_row_layout() == 'tabs_component' ): // nested layout: ?>
	...
	<div class="custom-tabs tab-container <?php echo $tabsWidth; ?> <?php echo $tabsRows; ?>">
...
<?php endif; ?>
	...
	<?php elseif (get_sub_field('tabs_select') == 'vertical') :?>
       <?php  echo '<h2>vertical tabs</h2>'; ?>
...
<div class="row collapse tabs-vertical">
	<div class="columns">
