...
<?php
	...
	$navOffCanvasMenuColor	= get_field('off_canvas_menu_color','options');
?>
...
<style>
	...
	<?php if($navOffCanvasMenuColor):?>
		.hamburger-inner,
		.hamburger-inner:after,
		.hamburger-inner:before {
			background: <?php echo $navOffCanvasMenuColor;?>;
		}
	<?php endif;?>
</style>
...
<button data-toggle="off-canvas" class="hamburger hamburger--<?php echo get_field('off_canvas_menu_animation','options');?>" type="button">
