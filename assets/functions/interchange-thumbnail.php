...
//add_filter( 'the_content', 'replace_images_with_interchange_thumbnail' );
...
add_filter( 'post_thumbnail_html', 'replace_images_with_interchange_thumbnail' );

// build an interchange image tag for all uploaded images in the ACF Editor WYSIWYG
//add_filter( 'acf_the_content', 'replace_images_with_interchange_thumbnail' );
 ...
 * @return string
 */
function replace_images_with_interchange_thumbnail($content) {
      ...
      foreach ($image_matches[0] as $image_collection) {
        ...
        if (is_array($image_collection) && !empty($image_collection)) {
          ...
          if (strpos($image_tag, $uploads_path)) {
            ...
            $attachment_id = attachment_id_thumbnail($src_value);
            ...
            if ($attachment_id) {
				...
				$mobile_image_large = wp_get_attachment_image_src($attachment_id, 'mobile-small');
			  ...
			  if ($mobile_image_small && $retina_small && $mobile_image_medium && $retina_medium && $mobile_image_large && $retina_large && $standard_image) {
				  ...
				  $interchange_tag = ' data-interchange="[' . $mobile_image_small[0] . ', only screen and (min-width: 1px)], [' . $retina_small[0] . ', only screen and (min-width: 1px) and (-webkit-min-device-pixel-ratio: 2), only screen and (min-width: 1px) and (min--moz-device-pixel-ratio: 2), only screen and (min-width: 1px) and (-o-min-device-pixel-ratio: 2/1), only screen and (min-width: 1px) and (min-device-pixel-ratio: 2), only screen and (min-width: 1px) and (min-resolution: 192dpi), only screen and (min-width: 1px) and (min-resolution: 2dppx)], [' . $mobile_image_medium[0] . ', only screen and (min-width: 641px)], [' . $retina_medium[0] . ', only screen and (min-width: 641px) and (-webkit-min-device-pixel-ratio: 2), only screen and (min-width: 641px) and (min--moz-device-pixel-ratio: 2), only screen and (min-width: 641px) and (-o-min-device-pixel-ratio: 2/1), only screen and (min-width: 641px) and (min-device-pixel-ratio: 2), only screen and (min-width: 641px) and (min-resolution: 192dpi), only screen and (min-width: 641px) and (min-resolution: 2dppx)], [' . $mobile_image_large[0] . ', only screen and (min-width: 1025px)], [' . $retina_large[0] . ', only screen and (min-width: 1025px) and (-webkit-min-device-pixel-ratio: 2), only screen and (min-width: 1025px) and (min--moz-device-pixel-ratio: 2), only screen and (min-width: 1025px) and (-o-min-device-pixel-ratio: 2/1), only screen and (min-width: 1025px) and (min-device-pixel-ratio: 2), only screen and (min-width: 1025px) and (min-resolution: 192dpi), only screen and (min-width: 1025px) and (min-resolution: 2dppx)], [' . $mobile_image_large[0] . ', only screen and (min-width: 1441px)]"';
 ...
 */
function attachment_id_thumbnail( $url ) {
