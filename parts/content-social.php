...
<!--         <a href="mailto:?subject=Check%20out%20how%20ridiculously%20responsive%20these%20social%20buttons%20are&amp;body=http%3A%2F%2Fkurtnoble.com%2Flabs%2Frrssb%2Findex.html"> -->
      ...
      <li class="rrssb-twitter">
        ...
        <a href="https://twitter.com/intent/tweet?text=this is new content:<?php the_author(); ?> <?php the_title(); ?> <?php the_permalink(); ?> via @ <?php echo get_bloginfo( 'name' ); ?> <?php echo get_bloginfo( 'description' ); ?>">
          <span class="rrssb-icon">
      ...
      <li class="rrssb-linkedin">
        <!-- Replace href with your meta and URL information -->
        <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php the_permalink(); ?>&amp;title=<?php the_title(); ?>&amp;summary=<?php excerpt('35'); ?>" class="popup">
          <span class="rrssb-icon">
